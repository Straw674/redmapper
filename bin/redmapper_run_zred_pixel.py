...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Compute zreds for a single pixel')
    ...
    redmapper.pipeline.run_zred_pixel_task(args.configfile, args.pixel, args.nside, path=args.path)
